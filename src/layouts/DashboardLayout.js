...
import BillingTable from "../views/BillingTable.js";
import BillingForm from "../views/BillingForm.js";
      ...
      <div className="main-content" ref={mainContent}>
        ...
        <Switch>
          ...
          <Route
            ...
            component={CustomerForm}
          />
          <Route path="/dashboard/billings" exact component={BillingTable} />
          <Route path="/dashboard/billings/add" exact component={BillingForm} />
          <Route
            path="/dashboard/billings/:billingId/edit"
            exact
